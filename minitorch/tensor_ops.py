    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _map(
        ...
        for i in range(out_size):
            # Convert linear index to multi-dimensional index for out_shape
            to_index(i, out_shape, out_index)

            # Map out_index to in_index, handling broadcasting
    ...
    * Fill in the `out` array by applying `fn` to each
    ...
    def _zip(
        ...
        for i in range(out_size):
            ...
            # Map out_index to a_index and b_index, handling broadcasting
    ...
    * `out_shape` will be the same as `a_shape`
    ...
    def _reduce(
        ...
        for i in range(a_size):
            # Convert linear index to multi-dimensional index for a_shape
            to_index(i, a_shape, a_index)

            # Map a_index to out_index by make the index 0 at reduce_dim
